...
J.pP(v).h(0,"page__heading__breadcrumbs")
u=W.r3("a",null)
t=J.RE(u)
t.a7(u,"href","/")
t.shf(u,"Pinned giveaways")
v.appendChild(u)
t=J.RE(w)
t.gDD(w).h(0,"page__heading")
t.gDD(w).h(0,"sg2o-table-heading")
w.appendChild(v)
y.insertBefore(w,x)
x.setAttribute("style","margin-top: 0px imortant!;")
...
t.shf(u,"Page "+this.b+" of "+H.d(z.A7))
z=J.RE(v)
